...
export default function WorkScheduleStats() {
    ...
    const handleDateChange = (e) => {
        ...
        if (!newDate || isValidDate(parseInt(newDate), selectedMonth, selectedYear)) {
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        >
                            ...
                            {[...Array(selectedMonth && selectedYear ? getDaysInMonth(selectedMonth, selectedYear) : 31)].map((_, index) => (
                                <option 
                                    key={index + 1} 
                                    value={index + 1}
                                    disabled={selectedMonth && selectedYear && !isValidDate(index + 1, selectedMonth, selectedYear)}
                                >
                                    Ngày {index + 1}
                                </option>
                            ))}
